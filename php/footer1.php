...
<div class="container">
    <div class="footer">
        ...
        <div class="links">
            <a href="../why_us/?email=<?php echo $email['Email'] ?>">About Us</a>
            <a href="#events-collection">Events</a>
            <a href="../account/?email=<?php echo $email['Email'] ?>">Account</a>
            <a href="../find_your_ticket/?email=<?php echo $email['Email']?>">Find Your Ticket</a>
        </div>
        <a class="logo1" href="../homepage?email=<?php echo $email['Email']?>">
