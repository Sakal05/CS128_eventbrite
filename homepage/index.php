    ...
    <div class="container">
        <div class="category">
            <div>
                ...
                <br>
                <div class="five">
                    <svg id="music-note_svg__eds-icon--music-note_svg" x="0" y="0" viewBox="0 0 24 24" xml:space="preserve">
                        <path id="music-note_svg__eds-icon--music-note_base" fill="orangered" fill-rule="evenodd" clip-rule="evenodd" d="M21 2L8 5.5v11.3c-.5-.5-1.2-.8-2-.8-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3V9.5l11-3v7.2c-.5-.5-1.2-.8-2-.8-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3V2zM6 21c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM9 8.5V6.2l11-3v2.3l-11 3zm9 9.5c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z">
                        </path>
                    </svg>
                </div>
                <div class="twenty">
                ...
                <div class="five">
                    <i class="eds-vector-image1 eds-icon--small eds-vector-image1--ui-orange" data-spec="icon" data-testid="icon" aria-hidden="true"><svg id="travel_svg__eds-icon--travel_svg" x="0" y="0" viewBox="0 0 24 24" xml:space="preserve">
                            <path id="travel_svg__eds-icon--travel_base" fill-rule="evenodd" clip-rule="evenodd" fill="orangered" d="M12.5 10.4l1-1 1 1V13h-2v-2.6zM4 21h2V6H4v15zm11.5-7v-4L14 8.5V6h3v15H7V6h6v2.4L11.5 10v4h4zm2.5 7h2V6h-2v15zM9 5h6V3H9v2zM8 2v3H3v17h18V5h-5V2H8z">
                            </path>
                        </svg></i>
                </div>
                <div class="twenty">
                ...
                <div class="five">
                    <svg id="game_svg__eds-icon--game_svg" x="0" y="0" viewBox="0 0 24 24" xml:space="preserve">
                        <path id="game_svg__eds-icon--game_base" fill="orangered" fill-rule="evenodd" clip-rule="evenodd" d="M11 8h2V7h-2v1zm10 11H3V9h18v10zM14 8V6h-1.5V4h-1v2H10v2H2v12h20V8h-8z"></path>
                        <path id="game_svg__eds-icon--game_button" fill="orangered" fill-rule="evenodd" clip-rule="evenodd" d="M16 12c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 3c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z">
                        </path>
                        <path id="game_svg__eds-icon--game_pad" fill="orangered" fill-rule="evenodd" clip-rule="evenodd" d="M8 12H7v1.5H5.5v1H7V16h1v-1.5h1.5v-1H8z"></path>
                    </svg>
                </div>
                <div class="twenty">
                ...
                <div class="five">
                    <svg class="briefcase_svg__eds-icon--briefcase_svg" viewBox="0 0 24 24">
                        <path class="briefcase_svg__eds-icon--briefcase_base" fill="orangered" fill-rule="evenodd" clip-rule="evenodd" d="M17 14v-2h2v7H5v-7h2v2h1v-2h8v2h1zM4 7h16v4h-3v-1h-1v1H8v-1H7v1H4V7zm5-1h6V5H9v1zM8 4v2H3v6h1v8h16v-8h1V6h-5V4H8z">
                        </path>
                    </svg>
                </div>
                <div class="twenty">
                        ...
                        <div class="pic">
                            ...
                            <div class="popUp">
                                <button onclick="toggleLike(<?php echo $row['Event_ID']; ?>)">
                                    <div class="h-empty" id="h-empty-<?php echo $row['Event_ID']; ?>" style="display:<?php if ($row['Like_status'] == 0) {
                                                                                                                            echo "block;";
                                                                                                                        } else {
                                                                                                                            echo "none;";
                                                                                                                        } ?>">
                                    ...
                                    <div class="h-full" id="h-full-<?php echo $row['Event_ID']; ?>" style="display:<?php if ($row['Like_status'] == 1) {
                                                                                                                        echo "block;";
                                                                                                                    } else {
                                                                                                                        echo "none;";
                                                                                                                    } ?>">
