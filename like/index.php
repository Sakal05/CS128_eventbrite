        ...
        <div class="body_container">
            <div class="body_layout">
                ...
                <div class="events_container_widght">
                    ...
                    ?>
                        <article class="event_card_list" href="../detail/event-detail-1.php">
                            <div class="event_card_content remove_style">
                                <a href="../detail/event-detail-1.php">
                                    <h3>
                            ...
                            <div class="image_container_set">
                                <div class="event_image">
                                    <img src="<?php echo $row[2]; ?>" style="width: 220px;">
                                </div>
