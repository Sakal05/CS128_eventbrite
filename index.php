    ...
    <div class="container">
        ...
        <div class="category">
            <div>
                ...
                <div class="five">
                    <svg id="mask_svg__eds-icon--mask_svg" x="0" y="0" viewBox="0 0 24 24" xml:space="preserve">
                        <path id="mask_svg__eds-icon--mask_base" fill="orangered" fill-rule="evenodd"
                            clip-rule="evenodd"
                        ...
                        <path id="mask_svg__eds-icon--mask_mask" fill="orangered" fill-rule="evenodd"
                            clip-rule="evenodd"
                        ...
                        <path id="mask_svg__eds-icon--mask_mouth" fill="orangered" fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M11.9 13.2c-1.5 1.5-3.9 1.5-5.4 0l-.4-.4-.7.7.4.4c.9.9 2.2 1.4 3.4 1.4 1.2 0 2.5-.5 3.4-1.4l.4-.4-.7-.7-.4.4z">
                        </path>
                        <path id="mask_svg__eds-icon--mask_eye_1_" fill="orangered" fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M12.2 8.3c-.3.3-.8.3-1.1 0l-.3-.3-.7.7.4.4c.3.3.8.5 1.2.5.4 0 .9-.2 1.2-.5l.4-.4-.7-.7-.4.3z">
                        </path>
                        <path id="mask_svg__eds-icon--mask_eye" fill="orangered" fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="five">
                    <svg id="heart_svg__eds-icon--heart_svg" x="0" y="0" viewBox="0 0 24 24" xml:space="preserve">
                        <path id="heart_svg__eds-icon--heart_base" fill="orangered" fill-rule="evenodd"
                            clip-rule="evenodd"
            ...
            <div>
                ...
                <div class="five">
                    <svg id="cocktail_svg__eds-icon--cocktail_svg" x="0" y="0" viewBox="0 0 24 24" xml:space="preserve">
                        <path id="cocktail_svg__eds-icon--cocktail_base" fill-rule="evenodd" clip-rule="evenodd"
                            fill="orangered"
                ...
                <div class="five">
                    <svg id="shoe_svg__eds-icon--sport_svg" x="0" y="0" viewBox="0 0 24 24" xml:space="preserve">
                        <path id="shoe_svg__eds-icon--sport_base" fill-rule="evenodd" clip-rule="evenodd"
                            fill="orangered"
                    ...
                    <img src="<?php echo ($row["2"]) ?>">
                        <div class="popUp">
                            <button onclick="toggleLike(<?php echo $i ?>)">
                                <div class="h-empty" id="h-empty-<?php echo $i ?>" style="display:<?php if ($row["10"]==0){echo "block;";} else { echo "none;";}?>">
                                ...
                                <div class="h-full" id="h-full-<?php echo $i ?>" style="display:<?php if ($row["10"]==1){echo "block;";} else { echo "none;";}?>">
