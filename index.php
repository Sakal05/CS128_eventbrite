                    ...
                    <img src="<?php echo ($row["2"]) ?>">
                        <div class="popUp">
                            <button onclick="toggleLike(<?php echo $i ?>)">
                                <div class="h-empty" id="h-empty-<?php echo $i ?>" style="display:<?php if ($row["10"]==1){echo "block;";}?>">
                                ...
                                <div class="h-full" id="h-full-<?php echo $i ?>" style="display:<?php if ($row["10"]==0){echo "none;";}?>">
