            ...
            <div class="block-center">
                <div class="form">
                    ...
                    <div class="submit-form">
                        ...
                        <br>
                        <div class="login-form">
                            <input type="text" id="fname" name="email" placeholder="First Name">
                        </div>
                        <br>
                        <div class="login-form">
                            <input type="text" id="lastname" name="email" placeholder="Last Name">
                        </div>
                        <br>
                        <div class="login-form">
                ...
                <div class="background-column">
                    <img src="	https://cdn.evbstatic.com/s3-build/perm_001/8aa0b4/django/images/login/lateral-image-3-hd.jpg">
                </div>
            </div>
        </div>
    </div>
